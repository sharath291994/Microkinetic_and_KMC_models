...
N_600K_no_interaction_downscaled = N;
Nfccs_600K_no_interaction_downscaled = Nfccs;
t_600K_no_int_downscaled = t;
cd('E:\Carbon_poisoning_models_final_calc\KMC_simulations\Methane_direct_diss_KMC\MK_scripts');
save(strcat('MK_no_interaction_',num2str(Temperature_MSR),'K_downscaled'),'N_600K_no_interaction_downscaled','Nfccs_600K_no_interaction_downscaled','t_600K_no_int_downscaled');   
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
