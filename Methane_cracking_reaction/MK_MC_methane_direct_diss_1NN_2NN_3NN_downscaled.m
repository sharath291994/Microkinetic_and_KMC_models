...
N_600K_1NN_2NN_3NN_downscaled = N;
Nfccs_600K_1NN_2NN_3NN_downscaled = Nfccs;
t_600K_1NN_2NN_3NN_downscaled = t;
cd('E:\Carbon_poisoning_models_final_calc\KMC_simulations\Methane_direct_diss_KMC\MK_scripts');
save(strcat('MK_1NN_2NN_3NN_',num2str(Temperature_MSR),'K_downscaled'),'N_600K_1NN_2NN_3NN_downscaled','Nfccs_600K_1NN_2NN_3NN_downscaled','t_600K_1NN_2NN_3NN_downscaled');   
end
...
K_CH3_CH2_H_fwd = K_CH3_CH2_H_fwd/10^(4); 
K_CH3_CH2_H_rev = K_CH3_CH2_H_rev/10^(4);  
K_CH2_CH_H_fwd =  K_CH2_CH_H_fwd/10^(6); 
K_CH2_CH_H_rev  = K_CH2_CH_H_rev/10^(6);
...
% 
% load('MC_IE_energies','CH_C_1NN_IE','C_CH_2NN_IE','C_CH_3NN_IE','CH_CH_1NN_IE',...
%      'CH_CH_2NN_IE','CH_CH_3NN_IE','C_C_1NN_IE','C_C_2NN_IE','C_C_3NN_IE');
...
K_CH2_CH_H_fwd_int = (Prexp_CH2_CH_H_fwd/10^(6)) * exp(-((Eact_CH2_CH_H_fwd_int*Energy_eV_to_J)/(Kb_MSR*Temperature_MSR))); 

K_CH2_CH_H_rev_int = (Prexp_CH2_CH_H_rev/10^(6)) * exp(-((Eact_CH2_CH_H_rev_int*Energy_eV_to_J)/(Kb_MSR*Temperature_MSR)));
...
K_CH3_CH2_H_fwd_int = (Prexp_CH3_CH2_H_fwd/10^(4))*exp(-((Eact_CH3_CH2_H_fwd_int*Energy_eV_to_J)/(Kb_MSR*Temperature_MSR)))

K_CH3_CH2_H_rev_int = (Prexp_CH3_CH2_H_rev/10^(4))*exp(-((Eact_CH3_CH2_H_rev_int*Energy_eV_to_J)/(Kb_MSR*Temperature_MSR)))
